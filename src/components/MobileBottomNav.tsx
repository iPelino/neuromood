...
const MobileBottomNav: React.FC = () => {
  ...
  return (
    <nav className="flex md:hidden fixed bottom-0 left-0 w-full justify-around items-center px-4 pb-safe h-20 bg-surface shadow-[0_-4px_6px_rgba(39,33,60,0.1)] z-50 rounded-t-lg pt-2 pb-4">
