...
const Sidebar: React.FC = () => {
  ...
  return (
    <nav className="hidden md:flex flex-col p-4 gap-stack-sm h-screen w-64 fixed left-0 top-0 bg-surface-container-low shadow-none z-40">
      ...
      <Link to="/log" className="w-full py-4 bg-primary-container text-on-primary-container rounded-full font-headline-md text-[16px] font-medium hover:bg-[#d6654b] active:scale-[0.98] transition-all shadow-sm flex items-center justify-center">
        Log Mood
      </Link>
    </nav>
  );
